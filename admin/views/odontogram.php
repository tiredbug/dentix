	...
	<table style="margin: 0 auto; width: 450px; text-align: center;">
		...
		<tr>
		<td class="gigi_posterior"><input type="text" name="gg_18" id="gg_18" value="<?php echo @get_post_meta($post->ID, 'gg_18', true); ?>" class="odont_input color"></td>
		<td class="gigi_posterior"><input type="text" name="gg_17" id="gg_17" value="<?php echo @get_post_meta($post->ID, 'gg_17', true); ?>" class="odont_input color"></td>
		<td class="gigi_posterior"><input type="text" name="gg_16" id="gg_16" value="<?php echo @get_post_meta($post->ID, 'gg_16', true); ?>" class="odont_input color"></td>
		<td class="gigi_posterior"><input type="text" name="gg_15" id="gg_15" value="<?php echo @get_post_meta($post->ID, 'gg_15', true); ?>" class="odont_input color"></td>
		<td class="gigi_posterior"><input type="text" name="gg_14" id="gg_14" value="<?php echo @get_post_meta($post->ID, 'gg_14', true); ?>" class="odont_input color"></td>
		<td class="gigi_anterior"><input type="text" name="gg_13" id="gg_13" value="<?php echo @get_post_meta($post->ID, 'gg_13', true); ?>" class="odont_input color"></td>
		...
		<td> </td>
		<td> </td>
		<td class="gigi_posterior"><input type="text" name="gg_55" id="gg_55" value="<?php echo @get_post_meta($post->ID, 'gg_55', true); ?>" class="odont_input color"></td>
